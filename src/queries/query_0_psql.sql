...
and d_date between '2001-01-25' and 
        (cast('2001-01-25' as date) + '90 days'::interval)
...
where 
	...
	and d_date between cast('2002-03-24' as date) 
				and (cast('2002-03-24' as date) + '30 days'::interval)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('2002-04-17' as date) 
 				and (cast('2002-04-17' as date) + '30 days'::interval)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-07-16' as date) and (cast('2001-07-16' as date) +  '60 days'::interval)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-26' as date) 
                  and (cast('2002-08-26' as date) +  '30 days'::interval) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-02-05' as date) - '30 days'::interval)
                and (cast ('1998-02-05' as date) + '30 days'::interval) 
 group by
    w_state,i_item_id
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-06' as date) 
                  and (cast('1998-08-06' as date) +  '14 days'::interval)
