...
where 
	...
	and d_date between cast('2002-03-22' as date) 
				and (cast('2002-03-22' as date) + '30 days'::interval)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-06-06' as date) and (cast('1998-06-06' as date) +  '60 days'::interval)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-11' as date) 
                  and (cast('2001-08-11' as date) +  '30 days'::interval) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-05-18' as date) - '30 days'::interval)
                and (cast ('2002-05-18' as date) + '30 days'::interval) 
 group by
    w_state,i_item_id
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-04' as date) 
                  and (cast('2001-08-04' as date) +  '14 days'::interval)
