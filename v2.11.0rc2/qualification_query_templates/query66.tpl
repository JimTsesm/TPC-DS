...
-- 
  define YEAR= 2001;
 define TIMEONE= 30838;
 define SMC = ulist(dist(ship_mode_carrier, 1, 1),2);
 define NETONE = text({"ws_net_paid",1});
 define NETTWO = text({"cs_net_paid_inc_tax",1});
 define SALESONE = text({"ws_ext_sales_price",1});
 define SALESTWO = text({"cs_sales_price",1});
 define _LIMIT=100; 
