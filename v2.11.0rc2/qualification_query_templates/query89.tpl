...
define CAT_A = "Books";
define CLASS_A = "computers";
define CAT_B = "Electronics";
define CLASS_B = "stereo";
define CAT_C = "Sports";
define CLASS_C = "football";
define CAT_D = "Men";
define CLASS_D = "shirts";
define CAT_E = "Jewelry";
define CLASS_E = "birdal";
define CAT_F = "Women";
define CLASS_F = "dresses";
define _LIMIT=100;
